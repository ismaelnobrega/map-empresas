(function (window, undefined) {
    var MapsLib = function (options) {
        ...
        this.locationColumn = options.locationColumn || "ENDERECO";
...
if (text_search != '')
  self.whereClause += " AND ATIVIDADE contains ignoring case '" + text_search + "'";
    ...
    var self = this;
	var selectColumns = 'NR_CNPJ, NO_PESSOA_JURIDICA, ATIVIDADE, ENDERECO, BAIRRO, NO_MUNICIPIO_COMERCIAL, ATEND_NAN ';
    var limite = 500;
    self.query({ 
      select: selectColumns, 
      where: whereClause,

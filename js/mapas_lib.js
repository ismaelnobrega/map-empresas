(function (window, undefined) {
    var MapsLib = function (options) {
        ...
        this.recordName = options.recordName || "empresa"; //for showing a count of results
        this.recordNamePlural = options.recordNamePlural || "empresas";
        ...
        if (typeof options.addrMarkerImage !== 'undefined') {
            ...
            this.addrMarkerImage = "images/male-2.png"
...
if (text_search != '')
  self.whereClause += " AND ATIVIDADE contains ignoring case '" + text_search + "'";
    ...
    MapsLib.prototype.displaySearchCount = function (json) {
        ...
        $("#result_box").fadeOut(function () {
            $("#result_count").html(self.addCommas(numRows) + " " + name + " encontradas ");
        });
        $("#result_box").fadeIn();
    };
    ...
    var self = this;
	var selectColumns = 'num_cnpj, NOME_PESSOA_JURIDICA, ATIVIDADE, ENDERECO, NO_BAIRRO_COMERCIAL, NO_MUNICIPIO_COMERCIAL, NAN ';
    var limite = 200;
    self.query({ 
      select: selectColumns, 
      where: whereClause,
    ...
    if (data == null) {
      //clear results list
      results.append("<li><span class='lead'>Nenhum resultado</span></li>");
    }
    else {
